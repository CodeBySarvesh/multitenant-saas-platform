...
urlpatterns = [
    ...
    path('tasks/comment/<int:pk>', TaskCommentAPIView.as_view()),
    path('task_comment/update/<int:pk>', TaskCommentUpdateAPIView.as_view()),
